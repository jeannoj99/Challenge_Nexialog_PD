...
# b (binaires)
data_for_binary = pd.read_csv("/app/data/app_data_binary.csv")
...
data_for_lc = pd.read_csv("/app/data/app_data_lc.csv")
...
data_for_hc_nd = pd.read_csv("/app/data/app_hc_no_disc.csv")

#dataset qui a les variables discrétisées numériques
data_for_hc_d_train = pd.read_csv("/app/data/app_hc_disc_train.csv")
data_discret = pd.read_csv("/app/data/app_discrete_checked.csv")
